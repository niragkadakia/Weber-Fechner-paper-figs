...
{\color{blue} Intro to adaptation}.

Sensory systems such as the olfactory periphery 



Main point: adaptation gives a mechanism to tune response to maximal efficiency, blind to the odor space.
