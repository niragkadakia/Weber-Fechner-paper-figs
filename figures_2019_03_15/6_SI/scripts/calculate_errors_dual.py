...
estimation as successful or not. This uses data generated by 
CS-variability-adaptation/CS_run.py and aggregated by 
CS-variability-adaptation/aggregate_objects.py.
