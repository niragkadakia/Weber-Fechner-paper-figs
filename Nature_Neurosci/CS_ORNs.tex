...
\newcommand{\authorlistannotated}{
  Nirag~Kadakia$^{1, 2\ast}$,
  Thierry~Emonet$^{2, 3}$
}
\newcommand{\authoraffiliations}{
  $^1$Swartz Fellow of Theoretical Neuroscience, 
      Yale University, 
      New Haven, CT, USA; \\
  $^2$Department of Cellular, Molecular, and Developmental Biology,
      Yale University, 
      New Haven, CT, USA; \\
...
\newcommand{\correspondingaddress}{
  Dr. Nirag Kadakia \\
  Yale University \\
  Department of Cellular, Molecular, and Developmental Biology \\
