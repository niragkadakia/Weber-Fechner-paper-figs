...
The system dynamics are schematized in Fig.~\ref{!!}. In the mean-field limit, the binding dynamics of these $2N + 2$ states are described by the master equations:
\begin{align}
