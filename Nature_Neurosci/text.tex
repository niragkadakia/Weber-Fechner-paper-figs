...
\begin{figure*}
	...
	\caption{\scriptsize{
		...
		\textbf{F}~Steady state Or/Orco activity for the three sample ORNs in (B), (C), and (D), in an unadaptive system (top row) and adaptive system (bottom row) in response to 100 different sparse odors. The row of each matrix corresponds to a distinct odor. The dispersedness of activity {\color{blue} finish} 
		}}
