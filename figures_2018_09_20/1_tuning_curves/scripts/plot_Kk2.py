...
def plot_Kk2(data_flag, seed_to_plot=0):
	"""
	...
	assert list(list_dict['iter_vars'].keys())[1] == 'seed_dSs', \
		'Second iter_var must be seed_dSs'
	...
	save_fig('Kk2_dSs_seed=%s' % seed_to_plot, subdir=data_flag)
